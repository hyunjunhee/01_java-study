...
public class Application1 {
    public static void main(String[] args) {
        ...
        // * toString() : 리스트 내의 요소들을 "[]". ","를 이용하여 하나의 문자열을 합쳐 반환되도록 오버라이딩
        System.out.println("list:" + list/*toString()*/);
        // 순서 유지, 중복 허용

        // * add(int index, E e) : 리스트 내의 인자로 전달된 인겟스 위치에 인자로 전달된 요소를 추가
        list.add(1, new Music("APT", "ROSE"));
        System.out.println("list: " + list);

        // * get(int index) : 리스트 내의 인자로 전달된 인덱스 위치의 요소를 E 타입으로 반환
