...
public class Application {
    ...
    /*
        ...
        3. 즉, 데이터를 효율적으로 저장하는 자료구조와 데이터를 효율적으로 처리하는 알고리즘이 미리 구현화되어있음

        ## 배열과 컬렉션의 차이점 ##
        1. 배열
           1) 크기에 대한 제약이 많음 (크기지정필수, 크기변경불가 => 새배열만들고 복사 / 크게 잡으면 메모리낭비 심함;
           2) 중간 위치에 추가하거나 삭제할 경우 복잡한 로직의 코드를 작성해야됨 (직접 알고리즘을 구현)
           3) 한 타입의 데이터만 저장 가능

        2. 컬렉션
           1) 크기에 대한 제약이 없음 (크기지정필수 x, 유동적으로 크기변경됨)
