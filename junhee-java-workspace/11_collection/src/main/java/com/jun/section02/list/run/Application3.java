package com.jun.section02.list.run;
...
public class Application3 {
    public static void main(String[] args) {
        ...
        // * set(int index, E e) => int index, Music e)
        ...
        System.out.println("2번 인덱스 Nusic 객체 제목: " + list.get(2).getTitle());

        // 1번 인덱스의 Music객체의 제목을 "저 밤"으로 수정
        list.get(1).setTitle("저 밤");

        System.out.println("수정후 1번 인덱스의 객체: " + list.get(1));
        ...
        List nonTypeList = Arrays.asList(new Music("술아 달다", "에픽하이"), new Music("이 밤", "양다일") ,"끝");
